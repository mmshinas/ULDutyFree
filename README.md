...
at least one photo has been uploaded on that device). It bakes those photos
directly into a fresh `index.html` you can download and re-upload to this
repo, overwriting the existing one.
